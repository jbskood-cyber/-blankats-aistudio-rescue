  ...
  return (
    <ScreenShell>
      <motion.div variants={stagger} initial="initial" animate="animate" className="space-y-4">
        ...
        <motion.section variants={fadeUp} className="px-5 pt-0">
          <div className="rounded-2xl border border-[#e8edf4] bg-white p-4 shadow-[0_8px_24px_rgba(15,25,55,0.04)]">
            ...
            <div className="grid h-[48px] grid-cols-2 gap-2 rounded-xl bg-[#f8fafc] p-1 border border-[#e2e8f0]">
              <button
                type="button"
                onClick={() => onVacancyMode("paste")}
                className={`flex items-center justify-center gap-1.5 rounded-lg transition-all duration-200 h-full ${
                  vacancyMode === "paste"
                    ? "bg-[#0068ff] text-white shadow-sm"
                    : "bg-white text-[#5f6673] border border-[#e2e8f0]/80 hover:bg-gray-50"
                }`}
              >
                <FileText className="h-4 w-4 shrink-0" />
                <span className="text-[13px] sm:text-sm font-bold whitespace-nowrap">Pegar vacante</span>
              </button>
              <button
                type="button"
                onClick={() => onVacancyMode("captures")}
                className={`flex items-center justify-center gap-1.5 rounded-lg transition-all duration-200 h-full ${
                  vacancyMode === "captures"
                    ? "bg-[#0068ff] text-white shadow-sm"
                    : "bg-white text-[#5f6673] border border-[#e2e8f0]/80 hover:bg-gray-50"
                }`}
              >
                ...
                <div className="flex flex-col items-start justify-center text-left leading-none">
                  <span className="text-[13px] sm:text-sm font-bold whitespace-nowrap">Capturas</span>
                  <span className="text-[10px] font-normal opacity-80 mt-0.5">(máx. 2)</span>
                </div>
              </button>
            </div>
            ...
            {vacancyMode === "paste" ? (
              <div className="mt-4">
                <textarea
                  ...
                  className="min-h-[120px] w-full resize-none rounded-xl border border-[#dbe2ec] bg-white p-3.5 text-[13.5px] leading-relaxed text-[#070b2f] outline-none placeholder:text-[#8a929f] transition duration-200 focus:border-[#0068ff]"
                  placeholder="Pega aquí la descripción de la vacante..."
                />
                <div className="mt-1.5 flex justify-end">
                  <span className="text-[11px] font-medium text-[#8a929f] bg-[#f8fafc] px-2 py-0.5 rounded-md border border-[#e2e8f0]/50">
                    {vacancyText.length}/4000
                  </span>
                </div>
              </div>
            ) : (
              <div className="mt-4">
                ...
                <button
                  ...
                  className="flex min-h-[90px] w-full flex-col items-center justify-center gap-2 rounded-xl border border-dashed border-[#8aa5c7] bg-[#fbfdff] px-4 py-3 text-center text-sm font-bold text-[#0068ff] transition duration-200 hover:bg-[#f4f8ff] disabled:cursor-not-allowed disabled:opacity-55"
                >
                  <Upload className="h-5 w-5 shrink-0" />
                  <span className="text-[13.5px]">Agregar captura de la vacante</span>
                  <span className="text-xs font-medium text-[#8a929f]">{vacancyCaptures.length}/2 capturas</span>
                </button>
